...
export const RATING_SYNC_LAST_RUN_SETTING = "jobs.ratingSync.lastRun";
export const TAG_SYNC_LAST_RUN_SETTING = "jobs.tagSync.lastRun";
export const METADATA_SYNC_LAST_RUN_SETTING = "jobs.metadataSync.lastRun";
